...
var chartistPluginZoomExports = {};
var chartistPluginZoom = {
  get exports() {
    return chartistPluginZoomExports;
  },
  set exports(v) {
    chartistPluginZoomExports = v;
  }
};
...
const ChartistZoom = chartistPluginZoomExports;
...
const Graph_vue_vue_type_style_index_0_scoped_a9e898a6_lang = "";
...
const _sfc_main$1 = {
  ...
  mounted() {
    console.log(this.data.series[0]);
    console.log(
      "x: ",
      this.data.series[0].map((serie) => serie.x)
    );
    console.log(
      "y: ",
      this.data.series[0].map((serie) => serie.y)
    );
    this.$watch(
      "data",
      () => {
...
const Graph = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-a9e898a6"]]);
...
const _sfc_main = {
  ...
  methods: {
    ...
    getIotUrl() {
      console.log(this.$viewer.api.apiUrl);
    ...
    getSeries(meters) {
      ...
      meters.forEach((meter) => {
        const records = meter.measurements.map(
          ({ records: records2 }) => records2.map((record) => ({
