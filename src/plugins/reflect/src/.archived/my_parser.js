...
class UnexpectedInput extends LarkError {
  // const pos_in_stream = null;
  // const _terminals_by_name = null;
...
var MEMO = {
  ...
  3: {
    ...
    pattern: {
      value:
        "(?:(?:\\+|\\-))?(?:(?:[0-9])+(?:e|E)(?:(?:\\+|\\-))?(?:[0-9])+|(?:(?:[0-9])+\\.(?:(?:[0-9])+)?|\\.(?:[0-9])+)(?:(?:e|E)(?:(?:\\+|\\-))?(?:[0-9])+)?)",
      flags: [],
      _width: [2, 4294967295],
      __type__: "PatternRE",
    },
  ...
  10: {
    ...
    pattern: {
      value:
        "[0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_$]{22}",
      flags: [],
      _width: [22, 22],
      __type__: "PatternRE",
    },
