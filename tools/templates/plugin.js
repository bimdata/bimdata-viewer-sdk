...
export default {
  ...
  addToWindows: ["3d", "2d"],
  button: {
    position: "{{iconPosition}}", // Add an icon in the left or right panel. Value can be "left" or "right"
    content: "{{menuType}}",  // How the viewer show the plugin content. Value can be "windowed", "simple" of "free"
